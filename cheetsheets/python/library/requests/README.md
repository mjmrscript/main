...
2. [Install Requests | نصب کتابخانه requests](#install-requests)
3. [Use Library | استفاده از کتابخانه](#use-library)
4. [HTTP Methods | متدهای HTTP](#http-methods)
5. [Response Methods | متدهای Response](#response-methods)
6. [GET Request | درخواست GET](#get-request)
7. [Query Parameters | پارامترهای کوئری](#query-parameters)
8. [POST Request | درخواست POST](#post-request)
9. [PUT Request | درخواست PUT](#put-request)
10. [PATCH Request | درخواست PATCH](#patch-request)
11. [DELETE Request | درخواست DELETE](#delete-request)
12. [Headers | هدرها](#headers)
13. [Authentication | احراز هویت](#authentication)
    - [Method 1: Basic Auth | روش ۱](#method-1-basic-auth)
    - [Method 2: Bearer Token | روش ۲](#method-2-bearer-token--the-most-common-method-in-modern-apis)
14. [Working with Session | کار با Session](#working-with-session)
15. [Error Handling | مدیریت خطا](#error-handling)
16. [Timeout | تایم‌اوت](#timeout)
17. [Uploading and Downloading Files | آپلود و دانلود فایل](#uploading-and-downloading-files)
    - [Uploading a File | آپلود فایل](#uploading-a-file)
    - [Downloading a File (Image) | دانلود فایل (تصویر)](#downloading-a-file-eg-an-image)
    - [Downloading a File (Small) | دانلود فایل کوچک](#downloading-a-file-file-not-big)
18. [Cookies | کوکی‌ها](#cookies)
19. [HTTP Status Code Table | جدول کدهای وضعیت HTTP](#http-status-code-table)
20. [Best Practices | بهترین شیوه‌ها](#best-practices)
21. [Further Resources | منابع بیشتر](#further-resources)
22. [EXAMPLE | مثال‌ها](#example)
